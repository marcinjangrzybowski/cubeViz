...
var $author$project$TestRun$init = function (flags) {
	return _Utils_Tuple2(
		{code: $elm$core$Maybe$Nothing, output: $elm$core$Maybe$Nothing},
		$elm$core$Platform$Cmd$none);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$TestRun$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$ParserHelp$deadEndsToString2 = function (deadEnds) {
...
function $author$project$MicroAgda$Parser$cyclic$mainParser() {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$parser$Parser$ignorer,
								$elm$parser$Parser$succeed($author$project$MicroAgda$Raw$Pi),
					...
					A2(
						...
						A2(
							...
							A2(
								...
								$elm$parser$Parser$lazy(
									function (_v2) {
										return $author$project$MicroAgda$Parser$cyclic$mainParser();
									}),
								$elm$parser$Parser$spaces),
							$elm$parser$Parser$symbol(') →')),
						$elm$parser$Parser$spaces)),
...
try {
	var $author$project$MicroAgda$Parser$mainParser = $author$project$MicroAgda$Parser$cyclic$mainParser();
	$author$project$MicroAgda$Parser$cyclic$mainParser = function () {
		return $author$project$MicroAgda$Parser$mainParser;
	};
...
var $author$project$MicroAgda$Raw$raw2String = function (x) {
	switch (x.$) {
		case 'Pi':
			var a = x.a;
			var b = x.b;
			var c = x.c;
			return '∀ (' + (a + (' : ' + ($author$project$MicroAgda$Raw$raw2String(b) + (') → ' + $author$project$MicroAgda$Raw$raw2String(c)))));
		case 'Var':
			var a = x.a;
			return a;
		default:
			var a = x.a;
			var b = x.b;
			return '(' + ($author$project$MicroAgda$Raw$raw2String(a) + (' ' + ($author$project$MicroAgda$Raw$raw2String(b) + ')')));
	}
};
...
var $author$project$TestRun$update = F2(
	function (msg, model) {
		var code = msg.a;
		var parsed = A2($elm$parser$Parser$run, $author$project$MicroAgda$Parser$mainParser, code);
		if (parsed.$ === 'Ok') {
			var raw = parsed.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						output: $elm$core$Maybe$Just(
							$author$project$MicroAgda$Raw$raw2String(raw))
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var ers = parsed.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						code: $elm$core$Maybe$Just(code),
						output: $elm$core$Maybe$Just(
							$author$project$ParserHelp$deadEndsToString2(ers))
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$TestRun$view = function (model) {
	return {
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($elm$core$Maybe$withDefault, 'no-output', model.output))
							]))
					]))
			]),
...
var $author$project$TestRun$main = $elm$browser$Browser$document(
	{init: $author$project$TestRun$init, subscriptions: $author$project$TestRun$subscriptions, update: $author$project$TestRun$update, view: $author$project$TestRun$view});
_Platform_export({'TestRun':{'init':$author$project$TestRun$main(
